## LLM10:2025 Безграничное потребление
...
#### 2. Ограничение экспозиции логитов и логарифмов вероятности
  Ограничьте или затемните экспозицию `logit_bias` и `logprobs` в ответах API. Предоставляйте только необходимую информацию, не раскрывая детализированные вероятности.
